...
function LocationMap() {
  ...
  useEffect(() => {
    mapboxgl.accessToken =
      "pk.eyJ1IjoiZHl4OTUyMjczMTExIiwiYSI6ImNtNnlrN2w4bDA3NWsya29iMXV4OXB4NjIifQ.dKXAXIkR-Beo9upl5D227Q";
    ...
    mapRef.current.on("load", () => {
      ...
      el.className = "marker";
      el.href =
        "https://www.google.com/maps/search/?api=1&query=25-29+French+Avenue+Bankstown";
      el.target = "_blank";
