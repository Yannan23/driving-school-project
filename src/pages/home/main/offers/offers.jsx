  ...
  <>
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center gap-4">
        <h3 className="text-base md:text-lg !font-bold mb-4 capitalize">
          {title}
        </h3>
        <div className="flex flex-col gap-2">
          {description.map((line, index) => (
            <p
              key={index}
              className="text-sm text-gray-600 capitalize px-2 text-center"
            >
              {line}
            </p>
          ))}
        </div>
        <p className="text-xl md:text-2xl font-bold mt-2 text-gray-800">
          {price}
        </p>
      ...
      <div className="absolute -bottom-5 left-0 w-full flex justify-center">
        <NavLink
          to="contact-us"
          className="w-4/5 py-2 px-4 bg-yellow text-white! text-center capitalize transition-colors duration-300 hover:bg-orange-500"
        >
          BOOK NOW
        </NavLink>
      </div>
...
const Offers = () => {
  const offers = [
    ...
    {
      title: "Beginner 1 Hour Lesson",
      description: ["1 - hour lesson", "3 Hours Log Book = 1 Hour"],
      price: "$70",
    },
    {
      title: "Beginner 2 Hour Lesson",
      description: ["2 - hour lesson", "6 Hours Logbook = 2 Hours"],
      price: "$120",
      savings: "(save $20)",
      isHot: false,
    },
  ...
  const packages = [
    {
      title: "6 Hour Lesson Package",
      description: ["6 - Hour Lesson", "6 Hours Logbook = 18 Hours"],
      price: "$360",
      savings: "(save $60)",
      isHot: false,
      limitedTime: false,
    ...
    {
      title: "10 Hour Lesson Package",
      description: ["10 - hour lesson", "30 Hours Logbook = 10 Hours"],
      price: "$600",
      savings: "(save $100)",
      isHot: true,
    ...
    {
      title: "20 Hour Lesson Package",
      description: ["20 - hour lesson", "60 Hours Logbook = 20 Hours"],
      price: "$1200",
      savings: "(save $200)",
      isHot: true,
      limitedTime: "won't last long!!",
    },
    {
      title: "RMS DRIVING TEST",
      description: [
        "* Pick up & Drop Off Include",
        "*30 Mins Skim Through  Pre Road Test Before Exam",
        "*Use Instructor RMS Approved Vehicle",
      ],
      isHot: false,
      price: "$200",
      limitedTime: false,
  ...
  return (
    <div className="w-full text-dark-color px-4 md:px-8 lg:!px-16">
      ...
      <div className="flex justify-center items-center text-white my-10 md:my-16">
        <NavLink
          to="package"
          className="py-2 px-4 w-4/5 md:w-3/5 lg:w-2/5 bg-dark text-white text-center capitalize transition-colors duration-300 hover:bg-red-600"
        >
          SEE ALL COURSES
        </NavLink>
      </div>
