...
const Banner = () => {
    return (
        <div className="bg-[url('/images/banner-image.jpg')] mt-[120px] bg-cover bg-center bg-no-repeat w-full py-4 md:py-8 md:h-fit lg:bg-top">
            {/** banner content */}
            <div className="flex flex-col justify-start items-start h-full w-[70%] gap-4 text-white px-8 py-10 sm:px-12 sm:py-20 sm:gap-8 md:px-12 md:py-24 md:!w-[60%] !ml-4 md:!ml-8 lg:!ml-16">
