...
const VideoPlayer = () => {
  return (
    <div className="w-full h-full p-6 pb-8 md:pb-16 md:px-16">
      <h2 className="!font-semibold py-4 md:py-8">
        <span className="text-2xl md:text-3xl">YOU NEED TO KNOW</span>
      </h2>
