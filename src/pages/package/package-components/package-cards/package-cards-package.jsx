...
const PackageCards = () => {
  return (
    <div className="package-cards-box">
      <h1 className="package-cards-box-title">Lessons</h1>
      ...
      <div className="package-cards-card">
        <div className="package-cards-card-header">
          ...
          <span className="package-cards-card-limited-label">
            Wouldn't Last Long!!
          </span>
        ...
        <div className="package-cards-card-content-box">
          <span className="package-cards-card-content">
            <ul>
              <li className="package-cards-card-content-save">
                <strong>Save $60 great discount for student</strong>
              </li>
      ...
      <div className="package-cards-card">
        <div className="package-cards-card-header">
          <span className="package-cards-card-name">
        ...
        <div className="package-cards-card-content-box">
          <span className="package-cards-card-content">
            <ul>
              <li className="package-cards-card-content-save">
                <strong>Save $100 awesome discount for student</strong>
              </li>
      ...
      <div className="package-cards-card">
        ...
        <div className="package-cards-card-content-box">
          <span className="package-cards-card-content">
            <ul>
              <li className="package-cards-card-content-save">
                <strong>$200 Big savings discount for student</strong>
              </li>
