...
const ContactUs = () => {
    ...
    const onChange = (val) => setcapVal(val);
    ...
    return (
        <div className='mt-[130px] font-Roboto-Condensed'>
            <div className='flex justify-center items-center flex-col'>
                <h1 className="uppercase !text-xl md:!text-2xl p-4 text-center !font-bold">book now / contact us</h1>
                <img src="../../../public/images/line.jpg" className='w-1/6 md:w-1/9 !h-0.5 md:!h-1 mb-4' alt="" />
            </div>

            <div className='md:grid md:grid-cols-2 grid-flow-dense'>
                {/** form */}
                <div className='md:col-start-2 flex flex-col p-4 gap-4'>
                    <h2 className='uppercase text-yellow !font-bold'>book now</h2>
                    <form onSubmit={handleSubmit} className='w-full flex flex-col gap-2'>
                        <input type="text" className='bg-yellow-400 h-10 w-full px-4' placeholder='Name' />
                        <input type="email" className='bg-yellow-400 h-10 w-full px-4 capitalize' placeholder='email' />
                        <input type="text" className='bg-yellow-400 h-10 w-full px-4 capitalize' placeholder='phone' />
                        <DropdownInput />
                        <textarea className='bg-yellow-400 h-40 w-full px-4 !py-2 capitalize text-start' placeholder='message' />
                        ...
                        <button disabled={!capVal} className='!bg-dark !w-full h-16 !text-yellow !uppercase !text-2xl hover:! hover:!text-white hover:!bg-yellow-400 cursor-pointer'>submit</button>
                    </form>
                </div>
