  ...
  return (
    <div className="mt-[130px] font-Roboto-Condensed p-2 md:p-4 lg:p-8">
      <div className="flex justify-center items-center flex-col">
        <h1 className="uppercase !text-xl md:!text-2xl p-4 text-center !font-bold">
          book now / contact us
        </h1>
        <img
          src="/images/line.jpg"
          className="w-1/6 md:w-1/9 !h-0.5 md:!h-1 mb-2 lg:mb-4"
          alt=""
        />
      </div>
      <div className="md:grid md:grid-cols-2 grid-flow-dense md:p-4 lg:px-8">
            ...
            >
              ...
              <div>
                <textarea
                  ...
                  className="bg-yellow-400 h-40 w-full px-4 py-2 capitalize text-start"
                  placeholder="message"
                />
                {errors.message && (
        ...
        <div className="md:col-start-1 flex flex-col p-4 lg:p-8 gap-2">
          <h2 className="uppercase text-yellow !font-bold px-4 md:pt-8 ">
            contact info
          </h2>
          <div className="py-2 px-4">
          ...
          <div className="mb-4 sm:py-2 sm:mb-4 lg:pb-8">
            <h2 className="uppercase text-yellow !font-bold p-4">
              areas we cover
            </h2>
            <p className="px-4 text-justify capitalize">
              Bankstown | Canterbury | Georges Hall | Hurtsville | Liverpool |
              Rhodes Campsie | Lakembha | Wiley Park | Lidcomb | Condell Park |
              Roseland | Burwood | Yagoona | Cabramatta | Revesby | condell park
              | padstow | Riverwood | Narwee | Bevery Hills | Mount Lewis |
              Greenacre | Chullora | Strathfield | Burwood | Rosemeadow | St
              Helens Park |Ambervale | Campbelltown | Bradbury | Glen alpine |
              Airds | Ruse | Lumeah | Blair Athol | Minto | Claymore | Eschol
              Park | Eagle Vale | Ingleburn | Glenfield
            </p>
            <p className="text-xs p-4 text-justify text-amber-400">
              * Please note Pick and Drop off might occour in long distance
              ONLY. If Your Suburb not shows in the list please call us for
              check your suburb if its avaialble or not. We provide mostly
              greater park of sydney and will assist you as fast as possible.
            </p>
          </div>
        </div>
      </div>
